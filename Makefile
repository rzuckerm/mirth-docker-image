MIRTH_VERSION := $(shell cat MIRTH_VERSION)
MIRTH_DEPS := $(wildcard MIRTH_*)
DOCKER_TAG_PREFIX := rzuckerm/mirth:$(MIRTH_VERSION)
...
$(META_BUILD_TARGET): Dockerfile Makefile $(MIRTH_DEPS)
